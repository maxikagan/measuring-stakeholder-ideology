#!/bin/bash
#SBATCH --job-name=advan_complete
...
#SBATCH --output=/global/scratch/users/maxkagan/project_oakland/foot_traffic_monthly_complete_2026-01-12/download_%j.log
#SBATCH --error=/global/scratch/users/maxkagan/project_oakland/foot_traffic_monthly_complete_2026-01-12/download_%j.err

OUTPUT_DIR="/global/scratch/users/maxkagan/project_oakland/foot_traffic_monthly_complete_2026-01-12"
PROJECT_ID="prj_eqp8pjkc__fldr_d7cqhjcmhmvsaqh8a"
